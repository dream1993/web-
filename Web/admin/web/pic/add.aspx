<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add.aspx.cs" Inherits="Web.admin.web.pic.add" %>
    ...
    <div class="main">
        ...
        <form name="managerForm" action="../ajax/acticle.ashx" method="post">
            <table class="table web" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    <td><input type="hidden" name="returnurl" value="../pic/add.aspx?pid=<%=pid %>" /></td>
