<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add.aspx.cs" Inherits="Web.admin.web.down.add" %>
        ...
        <form name="managerForm" action="../ajax/acticle.ashx" method="post">
            <table class="table web" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    <th>上传图片</th>
                    <td>
                        <a href="javascript:void(0);" id="uploadpic" onclick="upFiles()">上传文件</a>
                   <input type="hidden" name="imgSrc" id="imgSrc1" />
                    </td>
                </tr>
                <tr>
                    <td><input type="hidden" name="returnurl" value="../down/add.aspx?pid=<%=pid %>" /></td>
