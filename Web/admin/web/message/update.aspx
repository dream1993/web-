<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="update.aspx.cs" Inherits="Web.admin.web.message.update" %>
        ...
        <form name="managerForm" action="../ajax/acticle.ashx?id=<%=av.id %>" method="post">
            <table class="table web" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    <th>描述/地址</th>
                    <td>
                  <input type="text" name="url" value="<%=av.url %>" />
                ...
                <tr>
                    ...
                    <td><span class="btn btn_primary">
                        <input type="hidden" name="returnurl" value="../down/update.aspx?pid=<%=pid %>" />
