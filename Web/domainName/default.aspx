<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Web.domainName._default" %>
...
<head>
    ...
    <meta charset="utf-8">
    <title>欢迎登录域名管理系统</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="">
    <meta name="author" content="">
    <!-- CSS -->
    <link rel="stylesheet" href="../admin/style/reset.css">
    <link rel="stylesheet" href="../admin/style/supersized.css">
...
<body oncontextmenu="return false">
    <img src="../admin/img/logo.png" class="ilogo" />
