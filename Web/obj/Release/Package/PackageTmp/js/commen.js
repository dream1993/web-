...
window.onload=function () {
  ...
  // 服务页效果
  $('.on .serve-ba-box div').css('opacity', '.4')
  $('.on .serve-ba-txt img').css('transform', 'scale(1,1)').css('opacity', '1')
  $('.on .serve-ba-box .box-top-left').css('width', '25%')
  $('.on .serve-ba-box .box-top-right').css('width', '25%')
  $('.on .serve-ba-box .box-xia').css('width', '100%')
  $('.on .serve-ba-box .box-left').css('height', '100%')
  $('.on .serve-ba-box .box-right').css('height', '100%')
 //导航条
