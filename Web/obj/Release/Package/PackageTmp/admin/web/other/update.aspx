<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="update.aspx.cs" Inherits="Web.admin.web.other.update" %>
            ...
            <table class="table web" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    ...
                    <td><span class="btn btn_primary">
                        <input type="hidden" name="returnurl" value="../other/update.aspx?pid=<%=pid %>" />
