<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Web.admin.web.other._default" %>
...
<body id="iframe-body">
    <div class="main">
        ...
        <div class="address">
            ...
            <form name="from" method="post" action="default.aspx?pid=<%=pid %>">
            <%if(tlist.Count>0){ %>
               <select name="tid">
        ...
        <table class="table" cellpadding="1" cellspacing="1">
            ...
            <tr>
                ...
                <td>
                    <a href="../ajax/artzd.ashx?id=<%=rv.id %>&fine=<%=rv.fine %>&url=../other/?pid=<%=pid%>">
                ...
                <td><a href="update.aspx?id=<%=rv.id %>&pid=<%=pid %>" target="iframe">编辑</a> 
                    <%--| <a href="javaScript:void(0);" class="del" alt="../ajax/acticle.ashx?delid=<%=rv.id %>&cc=<%=pid %>&retuenurl=../other">删除</a>--%></td>
            </tr>
            <%} if (list.Count <= 0)
              {  %>
            <tr>
