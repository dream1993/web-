<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add.aspx.cs" Inherits="Web.admin.web.news.add" %>
        ...
        <form name="managerForm" action="../ajax/acticle.ashx" method="post">
            <table class="table web" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    <th>副标题</th>
                    <td>
                        <textarea name="realTitle" style="width:100%;height:100px;"></textarea>
                    </td>
                </tr>
                 <tr>
                    <th>关键字</th>
                ...
                <tr>
                    <td><input type="hidden" name="returnurl" value="../news/add.aspx?pid=<%=pid %>" /></td>
