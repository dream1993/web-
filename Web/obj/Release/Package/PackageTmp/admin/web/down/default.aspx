<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Web.admin.web.down._default" %>
        ...
        <table class="table" cellpadding="1" cellspacing="1">
            ...
            <tr>
                ...
                <td><a href="update.aspx?id=<%=rv.id %>&pid=<%=pid %>" target="iframe">编辑</a> 
                    | <a href="javaScript:void(0);" class="del" alt="../ajax/acticle.ashx?delid=<%=rv.id %>&cc=<%=pid %>&retuenurl=../down">删除</a></td>
            </tr>
            <%} if (list.Count <= 0)
              {  %>
            <tr>
