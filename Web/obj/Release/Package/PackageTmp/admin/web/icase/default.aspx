<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Web.admin.web.icase._default" %>
    ...
    <div class="main">
        ...
        <table class="table" cellpadding="1" cellspacing="1">
            ...
            <tr>
                ...
                <td>
                    <a href="../ajax/artzd.ashx?id=<%=rv.id %>&fine=<%=rv.fine %>&url=../icase/?pid=<%=pid%>">
                ...
                <td><a href="update.aspx?id=<%=rv.id %>&pid=<%=pid %>" target="iframe">编辑</a> | <a href="javaScript:void(0);" class="del" alt="../ajax/acticle.ashx?delid=<%=rv.id %>&cc=<%=pid %>&returnurl=../icase/">删除</a></td>
            </tr>
            <%} if (list.Count <= 0)
              {  %>
            <tr>
