<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="update.aspx.cs" Inherits="Web.admin.web.icase.update" %>
            ...
            <table class="table web" cellpadding="1" cellspacing="1">
                ...
                <%} %>
                    ...
                    <td id="imageView">
                        ...
                        <a class="upload dimg"><img src="<%=str %>" /><img  class="close" style="display: none;" value="' +<%=str %> + '" src="/admin/img/close.png" onclick="delimg(this)"  name="close"><input type="hidden" value="<%=str %>" name="pic" /></a>
                        
                        
                        <%} %>
                        <a href="javascript:void(0);" class="upload" id="J_selectImage">
                           上传图片</a>
                         <p style="color:#ff0000">依次上传：封面图片--封面Logo</p>
                    </td>
                </tr>
                ...
                <tr>
                    <td><input type="hidden" name="returnurl" value="../icase/update.aspx?pid=<%=pid %>" /></td>
