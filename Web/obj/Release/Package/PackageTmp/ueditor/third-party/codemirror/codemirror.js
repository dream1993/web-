...
var CodeMirror = (function() {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        function patchDisplay(from, to, intact) {
            ...
            doc.iter(from, to, function(line) {
                ...
                if (!nextIntact || nextIntact.from > j) {
                    ...
                    else scratch.innerHTML = line.gethtmls(ch1, ch2, true, tabText);
        ...
        function charFromX(line, x) {
            ...
            function getX(len) {
                measure.innerHTML = "<pre><span>" + lineObj.gethtmls(null, null, false, tabText, len) + "</span></pre>";
        ...
        function measureLine(line, ch) {
            ...
            measure.innerHTML = "<pre>" + line.gethtmls(null, null, false, tabText, ch) +
